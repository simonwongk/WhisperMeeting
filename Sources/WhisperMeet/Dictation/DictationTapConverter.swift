...
///
/// Thread model: `convert` is called only from the AVAudioEngine tap thread, which is serial, and
/// nothing else touches the converter for the lifetime of a capture. `@unchecked Sendable` records
